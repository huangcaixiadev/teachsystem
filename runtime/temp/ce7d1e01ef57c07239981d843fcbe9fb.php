<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:59:"E:\www\tp5\public/../application/index\view\user\login.html";i:1534057016;}*/ ?>
﻿<! DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<![endif]-->
<link href="/tp5/public/static/static/h-ui/css/H-ui.min.css" rel="stylesheet" type="text/css" />
<link href="/tp5/public/static/static/h-ui.admin/css/H-ui.login.css" rel="stylesheet" type="text/css" />
<link href="/tp5/public/static/static/h-ui.admin/css/style.css" rel="stylesheet" type="text/css" />
<link href="/tp5/public/static/lib/Hui-iconfont/1.0.8/iconfont.css" rel="stylesheet" type="text/css" />
<!--[if IE 6]>
		...
		<form class="form form-horizontal" action="" method="post">
			...
			<div class="row cl">
				<div class="formControls col-xs-8 col-xs-offset-3">
					...
					<img id="verify_img" src="<?php echo captcha_src(); ?>">
...
<script>
    $(function(){
        ...
        $("#login").on('click',function(event){
            $.ajax({
                type: "POST",//提交方式为POST
                url: "<?php echo url('checkLogin'); ?>",//设置提交数据处理的脚本文件地址
